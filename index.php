            ...
            <div class="content-container">
                <div class="main-container">
                    ...
                    foreach ($sections as $section) {
                        ...
                        $section_class = isset($category_class_map[$section]) ? $category_class_map[$section] : '';

                        echo '<section class="theme-section ' . $section_class . '">';

                        echo '<div class="section-title">';
                        echo '<h1>' . ucfirst($section) . '</h1>';
                        echo '<hr>';
                        echo '</div>';

                        $query = "SELECT * FROM vijesti WHERE kategorija='$section' AND arhiva=0 ORDER BY datum DESC LIMIT 3";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo '<p class="article-datum">' . date('d.m.Y.', strtotime($row['datum'])) . ' <span class="vertical-line">&#124;</span> ' . date('H:i', strtotime($row['datum'])) . '</p>';
                            echo '</div>';
